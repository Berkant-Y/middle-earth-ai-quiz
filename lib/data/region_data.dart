...
class RegionData {
  static const List<Region> _regions = [
    Region(
      ...
      x: 0.15,
      y: 0.25,
      imagePath: 'assets/images/Shire.jpg',
    ...
    Region(
      ...
      x: 0.30,
      y: 0.20,
      imagePath: 'assets/images/Rivendell.jpg',
    ...
    Region(
      ...
      x: 0.40,
      y: 0.55,
      imagePath: 'assets/images/Theoden.jpg', // Rohan Kralı
    ...
    Region(
      ...
      x: 0.50,
      y: 0.70,
      imagePath: 'assets/images/Gondor.jpg',
    ...
    Region(
      ...
      x: 0.35,
      y: 0.45,
      imagePath: 'assets/images/Fangorn.jpg',
    ...
    Region(
      ...
      x: 0.75,
      y: 0.65,
      imagePath: 'assets/images/Mordor_2.jpg',
    ...
    Region(
      ...
      x: 0.32,
      y: 0.35,
      imagePath: 'assets/images/Moria.jpg',
    ...
    Region(
      ...
      x: 0.25,
      y: 0.50,
      imagePath: 'assets/images/Isengard.jpg',
      type: RegionType.forest,
    ),
    Region(
      id: 'lothlorien',
      ...
      x: 0.45,
      y: 0.35,
      imagePath: 'assets/images/Lothlorien.jpg',
      type: RegionType.forest,
    ),
  ];
